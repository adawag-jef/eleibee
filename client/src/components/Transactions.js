...
const Transactions = () => {
  return (
    ...
    >
      <h2 className="text-4xl font-medium capitalize">Transactions</h2>
          ...
          >
            <div className="flex">
              ...
              <div className="flex flex-col ml-6">
                <span className="text-lg font-bold">@jeff</span>
                ...
                <div className="mt-4 flex">
                  <button
                    className="flex items-center
                                ...
                                dark:border-green-600 select-none text-green-400
                                hover:bg-green-400 hover:text-green-600
                                dark-hover:text-green-200 transition duration-300 ease-in-out"
                  >
                    <svg
                      className="h-5 w-5 fill-current mr-2 text-green-600"
                      viewBox="0 0 24 24"
                    >
                      <path
                        d="M14
                  ...
                  <button
                    className="flex items-center ml-4
                                ...
                                dark:border-red-600 select-none text-red-400
            hover:bg-red-400 hover:text-red-600
